...
const Home = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-tr from-[#f2fdfa] via-white to-[#e8f8f6] p-6">
      <div className="max-w-6xl mx-auto bg-white rounded-3xl shadow-2xl backdrop-blur-md p-10" data-aos="fade-up">
        <h1 className="text-4xl font-bold text-center text-[#229ea6] mb-10 tracking-wide">
          NRI Enquiry Form
        </h1>
        ...
        <form className="space-y-10" onSubmit={handleSubmit}>
          ...
          <section data-aos="fade-right">
            <h2 className="text-2xl font-semibold text-[#229ea6] flex items-center gap-2 mb-4">
          ...
          <section data-aos="fade-left">
            ...
            {formData.lovedOnes.map((person, i) => (
              <div key={i} className="grid grid-cols-1 md:grid-cols-6 gap-4 items-center mb-4">
                ...
                {formData.lovedOnes.length > 1 && i !== 0 && (
                  <button type="button" onClick={() => handleRemoveLovedOne(i)} className="text-red-500 hover:text-red-700">
                    <FaTrashAlt />
                  </button>
                )}
              </div>
            ...
            <div className="text-right">
              <button
                ...
                className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-[#229ea6] text-white text-sm shadow hover:scale-105 transition"
              >
                + Add Another Member
              </button>
            </div>
          ...
          <section data-aos="fade-up">
            ...
            <div className="flex flex-wrap gap-4 mt-4 text-sm">
              {['diabetes', 'bp', 'heart'].map((issue) => (
                <label key={issue} className="flex items-center gap-2 bg-[#ecfdfc] px-4 py-2 rounded-full shadow text-gray-700">
          ...
          <div className="text-center" data-aos="zoom-in">
            <button
              type="submit"
              className="mt-10 bg-[#229ea6] hover:bg-[#1b7f83] text-white text-lg px-10 py-3 rounded-full shadow-xl hover:scale-105 transition duration-300"
            >
              Submit Now
            </button>
          </div>
